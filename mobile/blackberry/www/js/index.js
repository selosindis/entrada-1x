    ...
    bindEvents: function() {
		...
		$(document).bind('init', function () {
			...
			function loadApp () {
				...
				$('.agenda').bind('touchstart click', function () {
				...
				$('.notices').bind('touchstart click', function () {
					if (!$(this).hasClass('ui-btn-active')) {
					...
					$.ajax({
						...
						success:function (data) {
							if (data != 'false') {
								...
								$('.mark').bind('touchstart click', function (e) {
									e.preventDefault();
				...
				$('#logout').bind('touchstart click', function () {
					...
					$('.notices, .agenda').unbind('touchstart click');
			...
			$('#save-settings').bind('touchstart click', function () {
				window.url = $('#url').val();
