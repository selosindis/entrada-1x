										...
										<div class="modal-dialog" id="file-edit-wizard-<?php echo $FILE_ID; ?>">
											<div id="wizard">
												...
												<div id="footer">
													...
													<input type="button" class="button" value="Re-Edit File" onclick="restartWizard('<?php echo ENTRADA_URL; ?>/api/file-wizard-course.api.php?action=edit&amp;id=<?php echo $IDENTIFIER; ?>&amp;fid=<?php echo $FILE_ID; ?>')" style="float: right; margin: 4px 10px 4px 0px" />
												</div>
											</div>
										</div>
										<?php
							...
							case 2 :
								...
								<div class="modal-dialog" id="file-add-wizard">
									<div id="wizard">
										...
										<div id="footer">
											<input type="button" class="button" value="Close" onclick="closeWizard()" style="float: left; margin: 4px 0px 4px 10px"/>
											<input type="button" class="button" value="Add Another File" onclick="restartWizard('<?php echo ENTRADA_URL; ?>/api/file-wizard-course.api.php?id=<?php echo $IDENTIFIER; ?>&amp;action=add')" style="float: right; margin: 4px 10px 4px 0px" />
										</div>
									</div>
								</div>
								<?php
