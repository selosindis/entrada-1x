                    ...
                    case "edit" :
                        if ($LTI_ID) {
                            ...
                            if ($result) {
                                            ...
                                            <div id="wizard">
                                                ...
                                                <div id="body">
                                                    ...
                                                    <div class="display-success">
                                                        You have successfully updated <strong><?php echo html_encode($PROCESSED["lti_title"]); ?></strong> in this event.
                                                    </div>
                                                ...
                                                <div id="footer">
                                                    ...
                                                    <input type="button" class="btn btn-primary" value="Re-Edit LTI Provider" onclick="restartWizard('<?php echo ENTRADA_URL; ?>/api/lti-wizard-event.api.php?action=edit&amp;id=<?php echo $EVENT_ID; ?>&amp;lid=<?php echo $LTI_ID; ?>')" style="float: right; margin: 4px 10px 4px 0px" />
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                ...
                                $ERROR++;
                                $ERRORSTR[] = "The provided LTI Provider identifier does not exist in the provided event." . $query;
                        ...
                        switch ($STEP) {
                            case 2 :
                                ...
                                <div class="modal-dialog" id="link-add-wizard">
                                    <div id="wizard">
                                        <h3 class="border-below">LTI Provider Wizard <span class="content-small space-left large"><strong>Adding</strong> new event LTI Provider</span></h3>
                                        <div id="body">
                                            <h2>LTI Provider Added Successfully</h2>

                                            <div class="display-success">
                                                You have successfully added <strong><?php echo html_encode($PROCESSED["lti_title"]); ?></strong> to this event.
                                            </div>
                                        ...
                                        <div id="footer">
                                            <input type="button" class="btn" value="Close" onclick="closeWizard()" style="float: left; margin: 4px 0px 4px 10px" />
                                            <input type="button" class="btn btn-primary" value="Add Another LTI Provider" onclick="restartWizard('<?php echo ENTRADA_URL; ?>/api/lti-wizard-event.api.php?id=<?php echo $EVENT_ID; ?>&amp;action=add')" style="float: right; margin: 4px 10px 4px 0px" />
                                        </div>
                                    </div>
                                </div>
                                <?php
