 ...
 * 
 * @version $Id: edit-forum.inc.php 1092 2010-04-04 17:19:49Z simpson $
*/
...
if ($RECORD_ID) {
	...
	if ($discussion_record) {
		if ((int) $discussion_record["forum_active"]) {
			...
			application_log("error", "The discussion forum record id [".$RECORD_ID."] is deactivated; however, ".$_SESSION["details"]["firstname"]." ".$_SESSION["details"]["lastname"]." [".$_SESSION["details"]["id"]."] has tried to edit it.");
		}
	} else {
		$ERROR++;
