			...
			<tbody>
				...
				foreach($results as $result) {
					...
					if ((int) $topics["posts"]) {
						...
						echo "	Time:</strong> ".date("M d Y, g:ia", $topics["updated_date"])."<br />\n";
						echo "	Topic:</strong> <a href=\"".COMMUNITY_URL.$COMMUNITY_URL.":".$PAGE_URL."?section=view-post&amp;id=".$topics["cdtopic_id"]."\">".limit_chars(html_encode($topics["topic_title"]), 25, true)."</a><br />\n";
						echo "	By: </strong>".$display."\n";
					} else {
