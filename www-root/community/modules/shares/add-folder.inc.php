	...
	default :
		...
		<form action="<?php echo COMMUNITY_URL.$COMMUNITY_URL.":".$PAGE_URL; ?>?section=add-folder&amp;step=2" method="post">
			<table style="width: 100%" cellspacing="0" cellpadding="2" border="0" summary="Add Shared Folder">
				...
				<tbody>
					<tr>
						<td colspan="2"><h2>Folder Details</h2></td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" id="folder_title" name="folder_title" value="<?php echo ((isset($PROCESSED["folder_title"])) ? html_encode($PROCESSED["folder_title"]) : ""); ?>" maxlength="64" style="width: 300px" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<textarea id="folder_description" name="folder_description" style="width: 98%; height: 60px" cols="50" rows="5"><?php echo ((isset($PROCESSED["folder_description"])) ? html_encode($PROCESSED["folder_description"]) : ""); ?></textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							...
							<tbody>
								...
								<tr>
									...
									<td class="on">
										<input type="checkbox" id="allow_member_read" name="allow_member_read" value="1"<?php echo (((!isset($PROCESSED["allow_member_read"])) || ((isset($PROCESSED["allow_member_read"])) && ($PROCESSED["allow_member_read"] == 1))) ? " checked=\"checked\"" : ""); ?> /></td>
									<td>
										<input type="checkbox" id="allow_member_upload" name="allow_member_upload" value="1"<?php echo (((!isset($PROCESSED["allow_member_upload"])) || ((isset($PROCESSED["allow_member_upload"])) && ($PROCESSED["allow_member_upload"] == 1))) ? " checked=\"checked\"" : ""); ?> /></td>
									<td class="on">
