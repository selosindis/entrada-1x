...
class Models_Assessments_DeletedTask extends Models_Base {
    protected $deleted_task_id, $adistribution_id, $target_id, $assessor_value, $assessor_type, $delivery_date, $deleted_reason_id, $deleted_reason_notes, $created_by, $created_date, $deleted_by, $deleted_date;
