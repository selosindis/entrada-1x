...
class Models_Assessments_Distribution_Releasor extends Models_Base {
    protected $adreleasor_id, $adistribution_id, $proxy_id, $created_date, $created_by;

    protected static $table_name = "cbl_assessment_distribution_releasors";
    ...
    public function fetchRowByProxyID($proxy_id) {
        return $this->fetchRow(array(
            array("key" => "adreleasor_id", "value" => $proxy_id, "method" => "=")
        ));
    }
    ...
    public function fetchAllByProxyID($proxy_id, $current_section = "assessments", $filters = array(), $search_value = null, $limit = 0, $offset = 0) {
        ...
        $query = "          SELECT a.* FROM `cbl_assessment_distribution_releasors` AS a
