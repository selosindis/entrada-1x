...
if((!defined("PARENT_INCLUDED")) || (!defined("IN_COMMUNITIES"))) {
	...
	if($COMMUNITY_ID) {
		...
		if($community_details) {
			...
			$BREADCRUMB[]		= array("url" => ENTRADA_URL."/admin/communities?".replace_query(array("section" => "modify")), "title" => "Manage Community");
			...
			if($ENTRADA_ACL->amIAllowed($community_resource, 'update')) {
				...
				switch($STEP) {
					case 3 :
						...
						$community_url	= ENTRADA_URL."/admin/communities";
...
<form action="<?php echo ENTRADA_URL."/admin/".$MODULE."?".replace_query(array("action" => "modify", "step" => 3)); ?>" method="post">
							<?php
					...
					<table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
						<tr>
							<td style="width: 25%; text-align: left">
								<input type="button" class="button" value="Cancel" onclick="window.location='<?php echo ENTRADA_URL."/admin/".$MODULE."?".replace_query(array("action" => "modify", "step" => 1)); ?>'" />
							</td>
			...
			<tr>
				...
				<td style="vertical-align: top">
					 ...
					 */
						...
						?>
<form action="<?php echo ENTRADA_URL."/admin/".$MODULE."?".replace_query(array("action" => "modify", "step" => 2)); ?>" method="post">
...
<form id="deactivate_community_form" action="<?php echo ENTRADA_URL."/admin/".$MODULE; ?>?section=deactivate" method="post">
