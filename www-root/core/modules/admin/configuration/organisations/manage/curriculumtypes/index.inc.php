...
?>
	...
	<div style="float: right">
		<ul class="page-action">
			<li><a href="<?php echo ENTRADA_URL; ?>/admin/configuration/organisations/manage/curriculumtypes?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="strong-green">Add New Curriculum Type</a></li>
		</ul>
	</div>
	<?php
		...
		<tbody>
			<?php
				foreach($results as $result){
					...
					echo"<td><a href=\"".ENTRADA_URL."/admin/configuration/organisations/manage/curriculumtypes?section=edit&amp;org=".$ORGANISATION_ID."&amp;type_id=".$result["curriculum_type_id"]."\">".$result["curriculum_type_name"]."</a></td><td>".(($result["curriculum_type_active"] == 1)?"Active":"Inactive")."</td></tr>";
				}
			?>
		</tbody>
	</table>
