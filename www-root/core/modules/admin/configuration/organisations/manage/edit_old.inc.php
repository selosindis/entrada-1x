 ...
 */
$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/configuration/organisations/manage?id=".$ORGANISATION['organisation_id']."&amp;section=edit", "title" => "Edit ".$ORGANISATION["organisation_title"]);
...
<form id ="editOrganisationForm" action = "<?php echo ENTRADA_URL;?>/admin/configuration/organisations/manage?section=edit&amp;id=<?php echo $ORGANISATION_ID;?>&amp;step=2" method = "post">
