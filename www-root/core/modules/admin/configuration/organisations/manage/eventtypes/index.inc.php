...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CONFIGURATION"))) {
	...
	<div style="float: right">
		<ul class="page-action">
			<li><a href="<?php echo ENTRADA_URL; ?>/admin/configuration/organisations/manage/eventtypes?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="strong-green">Add New Eventtype</a></li>
		</ul>
	</div>
	<?php
	...
	if($results){
	?>
	<form action ="<?php echo ENTRADA_URL;?>/admin/configuration/organisations/manage/eventtypes?section=delete&amp;org=<?php echo $ORGANISATION_ID;?>" method="post">
		...
		<tbody>
			<?php
				foreach($results as $result){
					...
					echo"<td><a href=\"".ENTRADA_URL."/admin/configuration/organisations/manage/eventtypes?section=edit&amp;org=".$ORGANISATION_ID."&amp;type_id=".$result["eventtype_id"]."\">".$result["eventtype_title"]."</a></td></tr>";
				}
			?>
		</tbody>
	</table>
