...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CONFIGURATION"))) {
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/configuration/organisations/manage/metadata?".replace_query(array("section" => "add"))."&amp;org=".$ORGANISATION_ID, "title" => "Add Meta Data");
