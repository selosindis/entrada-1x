...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CONFIGURATION"))) {
	...
	<div style="float: right">
		<ul class="page-action">
			<li><a href="<?php echo ENTRADA_URL; ?>/admin/configuration/organisations/manage/metadata?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="strong-green">Add New Meta Data</a></li>
		</ul>
	</div>
	<?php
	...
	if($metadata_types){
	?>
	<form action ="<?php echo ENTRADA_URL;?>/admin/configuration/organisations/manage/metadata?section=delete&amp;org=<?php echo $ORGANISATION_ID;?>" method="post">
			...
			<?php
				foreach($metadata_types as $type){
					if($type["parent_type_id"] == null){
						...
						echo"<td><a href=\"".ENTRADA_URL."/admin/configuration/organisations/manage/metadata?section=edit&amp;org=".$ORGANISATION_ID."&amp;meta=".$type["meta_type_id"]."\">".$type["label"]."</a></td></tr>";
