...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_OBJECTIVES"))) {
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/configuration/organisations/manage/objectives?".replace_query(array("section" => "add"))."&amp;id=".$ORGANISATION_ID, "title" => "Adding Objective");
	...
	switch ($STEP) {
		...
		case 1 :
			...
			?>
			<form action="<?php echo ENTRADA_URL."/admin/configuration/organisations/manage/objectives"."?".replace_query(array("action" => "add", "step" => 2))."&org=".$ORGANISATION_ID; ?>" method="post">
