			...
			*/
			...
			switch($STEP) {
				case 2 :
					...
					/**
					 * Check to see if course is private or open.
					 */
					if ((isset($_POST["permission"])) && ($permission = clean_input($_POST["permission"],array("trim")))) {
					...
					/**
					 * Check to see if ldap sync is enabled or not for events in this course.
					 */
