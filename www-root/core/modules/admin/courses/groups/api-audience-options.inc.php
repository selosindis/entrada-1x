	...
	if ($PROCESSED["course_id"]) {
		...
		if ($course_info) {
			...
			<tr class="group_members populated_members">
				<td>&nbsp;</td>
				<td style="vertical-align: top"><label for="faculty_name" class="form-nrequired">Populate From</label></td>
				<td>
					<table>
						<tbody>
							<?php
							if ($course_list) {
								?>
								<tr>
									<td style="vertical-align: top"><input type="radio" name="group_audience_type" id="group_audience_type_course" value="course" onclick="selectGroupAudienceOption('course')" style="vertical-align: middle"<?php echo ((($PROCESSED["group_audience_type"] == "course") || !isset($PROCESSED["group_audience_type"])) ? " checked=\"checked\"" : ""); ?> /></td>
									<td colspan="2" style="padding-bottom: 15px">
										<label for="group_audience_type_course" class="radio-group-title">All Learners Enrolled in <?php echo html_encode($course_info["course_code"]); ?></label>
							...
							if (($permission == "open")) {
								?>
								<tr>
									<td style="vertical-align: top"><input type="radio" name="group_audience_type" id="group_audience_type_custom" value="custom" onclick="selectGroupAudienceOption('custom')" style="vertical-align: middle"<?php echo ((($PROCESSED["group_audience_type"] == "custom") || (!$course_list)) ? " checked=\"checked\"" : ""); ?> /></td>
									<td colspan="2" style="padding-bottom: 15px">
