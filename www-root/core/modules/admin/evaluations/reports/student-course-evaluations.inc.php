		...
		default:
			...
			if ($results) {
				...
				<table class="tableList" cellspacing="0" cellpadding="1" summary="List of Course Evaluations">
					...
					<thead>
						<tr>
							<td class="title borderl">Evaluation Title</td>
					...
					foreach ($results as $result) {
						...
						echo "	<td class=\"general\"><a href=\"".$url."\">".($evaluators ? round($complete / ($evaluators * $result["evals"]) * 100)."%&nbsp;&nbsp;&nbsp;(".$complete."/".$evaluators.")" : "")."</a></td>\n";
						echo "</tr>\n";
					}
					?>
					</tbody>
