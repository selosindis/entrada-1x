            ...
            case "POST" :
                switch ($method) {
                                            ...
                                            if (!$ERROR) {
                                                ...
                                                if ($resource_class_work->$method()) {
                                                    ...
                                                    if (!$resource_entity->$method()) {   
                                                        ...
                                                        application_log("error", "Fialed to " .$method. " Classwork event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                    }
                                                } else {
                                            ...
                                            if (!$ERROR) {
                                                ...
                                                if ($resource_homework->$method()) {
                                                   ...
                                                   if (isset($PROCESSED["event_resource_entity_id"])) {
                                                    ...
                                                    if (!$resource_entity->$method()) {   
                                                        add_error("A problem occured while attempting to save this event resource. Please try again later.");
                                                        application_log("error", "Fialed to " .$method. " Homework event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                    }
                                        ...
                                        case 9:
                                            ...
                                            if (!$ERROR) {
                                                ...
                                                if ($resource_textbook_reading->$method()) {
                                                    ...
                                                    if (!$resource_entity->$method()) {   
                                                        add_error("A problem occured while attempting to save this event resource. Please try again later.");
                                                        application_log("error", "Fialed to " .$method. " Textbook reading event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                    }
                                        ...
                                        case 12 :
                                            ...
                                            switch ($PROCESSED["substep"]) {
                                                    ...
                                                    if (!$ERROR) {
                                                        if (isset($PROCESSED["event_resource_attach_file"]) && $PROCESSED["event_resource_attach_file"] == "no") {
                                                            ...
                                                            if ($resource_file->update()) {
                                                                ...
                                                                application_log("error", "Fialed to update File event resource entity " . $PROCESSED["efile_id"] . " for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                                echo json_encode(array("status" => "error", "data" => $ERRORSTR));
                                                            }
                                                        } else {
                                                            $PROCESSED["next_step"] = 4;
                                                ...
                                                case 2 :
                                                    if (!$ERROR) {
                                                        $PROCESSED["next_step"] = 4;
                                                        echo json_encode(array("status" => "success", "data" => array("next_step" => $PROCESSED["next_step"], "sub_step" => 3, "event_resource_type" => $PROCESSED["event_resource_type_value"])));
                                                    } else {
                                                        echo json_encode(array("status" => "error", "data" => $ERRORSTR));
                                                    }
                                                break;
                                                case 3 :
                                                    ...
                                                    if (!$ERROR) {   
                                                        ...
                                                        if ($resource_file->$method()) {
                                                            ...
                                                            if (!$resource_entity->$method()) {   
                                                                add_error("A problem occured while attempting to save this event resource. Please try again later.");
                                                                application_log("error", "Fialed to " .$method. " File event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                            }
                                        ...
                                        case 3 :
                                            ...
                                            if (!$ERROR) {
                                                ...
                                                if ($resource_link->$method()) {
                                                    ...
                                                    if (!$resource_entity->$method()) {   
                                                        add_error("A problem occured while attempting to save this event resource. Please try again later.");
                                                        application_log("error", "Fialed to " .$method. " Link event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                    }
                                        ...
                                        case 8 :
                                            ...
                                            switch ($PROCESSED["substep"]) {
                                                case 1 :
                                                    ...
                                                    if (!$ERROR) {
                                                        $substep = 2;
                                                        echo json_encode(array("status" => "success", "data" => array("sub_step" => $substep, "next_step" => 4, "event_resource_type" => $PROCESSED["event_resource_type_value"])));
                                                    } else {
                                                        echo json_encode(array("status" => "error", "data" => $ERRORSTR));
                                                    }
                                                break;
                                                ...
                                                case 3 :
                                                    ...
                                                    if (!$ERROR) {
                                                        ...
                                                        if ($resource_quiz->$method()) {
                                                            ...
                                                            if (!$resource_entity->$method()) {   
                                                                add_error("A problem occured while attempting to save this event resource. Please try again later.");
                                                                application_log("error", "Fialed to " .$method. " Quiz event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                            }
                                                            ...
                                                            add_error("A problem occured while attempting to save this event resource. Please try again later."); 
                                                            application_log("error", "Fialed to " .$method. " Quiz event resource for event: " . $PROCESSED["event_id"]);
                                                            echo json_encode(array("status" => "error", "data" => $ERRORSTR));
                                                        }
                                                    } else {
                                                        echo json_encode(array("status" => "error", "data" => $ERRORSTR));
                                        ...
                                        case 10 :
                                            ...
                                            if (!$ERROR) {
                                                ...
                                                if ($resource_lti_provider->$method()) {
                                                    ...
                                                    if (!$resource_entity->$method()) {   
                                                        add_error("A problem occured while attempting to save this event resource. Please try again later.");
                                                        application_log("error", "Fialed to " .$method. " LTI Provider event resource entity for event: " . $PROCESSED["event_id"] ." DB said:" . $db->ErrorMsg());
                                                    }
                    ...
                    case "delete" :
                        ...
                        if (!$ERROR) {
                            $resource_entity = Models_Event_Resource_Entity::fetchRowByID($PROCESSED["entity_id"]);
                            if ($resource_entity) {
                                ...
                                if (!$resource_entity->delete() && $entity) {
                                    ...
                                    if (!$ERROR) {
                                        ...
                                        echo json_encode(array("status" => "success", "data" => array("Successfully removed event resource")));
                                    } else {
