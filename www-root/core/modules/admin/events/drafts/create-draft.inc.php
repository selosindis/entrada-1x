						...
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align: top;">
									...
									echo "	<input type=\"button\" id=\"courses_list_remove_btn\" class=\"btn button-remove\" onclick=\"delIt()\" value=\"Remove\" />\n";
									echo "	<input type=\"button\" id=\"courses_list_add_btn\" class=\"btn button-add\" onclick=\"addIt()\" style=\"display: none\" value=\"Add\" />\n";
									echo "</div>\n";
