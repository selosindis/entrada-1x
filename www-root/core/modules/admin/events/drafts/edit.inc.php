                ...
                if ($ENTRADA_ACL->amIAllowed("event", "create", false)) {
                    ...
                    <div class="row-fluid space-below">
                        <div class="pull-right">
                            <a href="#import-csv" class="btn btn-small btn-default" data-toggle="modal"><i class="fa fa-upload"></i> Import CSV</a>
                            <?php if (!empty($draft_events)) : ?><a href="#export-results" id="export-results-button" class="btn btn-small btn-default" data-toggle="modal"><i class="fa fa-download"></i> <?php echo $translate->_("Export Results"); ?></a> <?php endif; ?>
