			...
			<table width="100%">
				<tr>
					...
					<td style="padding-top: 10px; text-align: right">
						...
						if ($ENTRADA_ACL->amIAllowed("event", "delete", false)) {
							?>
							<input class="btn" type="button" value="Publish Draft" onclick="window.location='<?php echo ENTRADA_URL . "/admin/events/drafts?section=status&action=approve&draft_id=".$draft_id; ?>';" />
							<?php
						}
						?>
					</td>
