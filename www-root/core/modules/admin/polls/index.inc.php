	...
	<?php if($ENTRADA_ACL->amIAllowed('poll', 'create')) : ?>
		<div style="float: right">
			<ul class="page-action">
				<li><a href="<?php echo ENTRADA_URL; ?>/admin/<?php echo $MODULE; ?>?section=add" class="strong-green">Add New Poll</a></li>
			</ul>
		</div>
		...
		<tfoot>
			<tr>
				...
				<td colspan="3" style="padding-top: 10px">
					<input type="submit" class="button" name="delete_polls" value="Delete Selected" />
					<input type="submit" class="button" name="expire_polls" value="Expire Selected" />
				</td>
			</tr>
		</tfoot>
		<?php endif; ?>
