	...
	switch ($STEP) {
		...
		default :
			if ($ENTRADA_ACL->amIAllowed(new ConfigurationResource($ORGANISATION_ID), "update")) {
				...
				<form id="editOrganisationForm" action="<?php echo ENTRADA_URL; ?>/admin/settings/manage?section=edit&amp;org=<?php echo $ORGANISATION_ID; ?>&amp;step=2" method="post">
						...
						<tfoot>
							<tr>
								<td colspan="2" style="padding-top: 25px;text-align: right;padding-right:45px;">
									<input type="button" class="button" value="Cancel" onclick="window.location='<?php echo ENTRADA_URL; ?>/admin/settings/manage?org=<?php echo $ORGANISATION_ID; ?>'" />
