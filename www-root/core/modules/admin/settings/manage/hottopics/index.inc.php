...
?>
	...
	<div style="float: right">
		<ul class="page-action">
			<li><a href="<?php echo ENTRADA_URL; ?>/admin/settings/manage/hottopics?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="strong-green">Add New Hot Topic</a></li>
		</ul>
	</div>
	<?php
		...
		<tbody>
			<?php
				foreach($results as $result){
					...
					echo"<td><a href=\"".ENTRADA_URL."/admin/settings/manage/hottopics?section=edit&amp;org=".$ORGANISATION_ID."&amp;topic_id=".$result["topic_id"]."\">".$result["topic_name"]."</a></td></tr>";
				}
			?>
		</tbody>
	</table>
