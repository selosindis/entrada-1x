...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_MEDBIQASSESSMENT"))) {
	...
	<div style="float: right">
		<ul class="page-action">
			<li><a href="<?php echo ENTRADA_URL; ?>/admin/settings/manage/medbiqassessment?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="strong-green">Add New Medbiquitos Assessment Method</a></li>
		</ul>
	</div><br/>
	<?php
