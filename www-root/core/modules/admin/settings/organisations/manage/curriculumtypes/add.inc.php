...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CONFIGURATION"))) {
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/organisations/manage/curriculumtypes?".replace_query(array("section" => "add"))."&amp;org=".$ORGANISATION_ID, "title" => "Add");
				...
				if ($db->AutoExecute("curriculum_lu_types", $PROCESSED, "INSERT")) {
					if ($TYPE_ID = $db->Insert_Id()) {
						...
						if ($db->AutoExecute("curriculum_type_organisation", $params, "INSERT")) {
							...
							$url = ENTRADA_URL . "/admin/settings/organisations/manage/curriculumtypes?org=".$ORGANISATION_ID;
							$SUCCESS++;
