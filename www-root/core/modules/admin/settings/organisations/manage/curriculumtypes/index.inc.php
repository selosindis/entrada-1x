...
?>
	...
	<div class="clearfix">
		<div class="pull-right">
			<a href="<?php echo ENTRADA_URL; ?>/admin/settings/organisations/manage/curriculumtypes?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="btn btn-primary">Add New Curriculum Type</a>
		</div>
	</div>
	<?php
