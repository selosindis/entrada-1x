	...
	if ($PROCESSED["remove_ids"]) {
		switch($STEP){
			case 2:
				...
				if($NOTICE)
					echo display_notice();
				$ONLOAD[] = "setTimeout('window.location=\\'".ENTRADA_URL."/admin/settings/organisations/manage/eventtypes/?org=".$ORGANISATION_ID."\\'', 5000)";
				break;
			case 1:
			default:
			...
			<form action ="<?php echo ENTRADA_URL."/admin/settings/organisations/manage/eventtypes/?section=delete&org=".$ORGANISATION_ID."&step=2";?>" method="post">
		...
		$ERROR++;
		$ERRORSTR[] = "No Event Types were selected to be deleted. You will now be redirected to the Event Type index; this will happen <strong>automatically</strong> in 5 seconds or <a href=\"".ENTRADA_URL."/admin/settings/organisations/manage/eventtypes/?org=".$ORGANISATION_ID."\" style=\"font-weight: bold\">click here</a> to continue.";
