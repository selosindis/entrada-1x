...
<?php
$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/organisations/manage/hottopics?section=delete&amp;org=".$ORGANISATION['organisation_id'], "title" => "Delete Hot Topics");
...
if ($PROCESSED["remove_ids"]) {
	switch($STEP){
		...
		if($NOTICE)
			...
			$ONLOAD[] = "setTimeout('window.location=\\'".ENTRADA_URL."/admin/settings/organisations/manage/hottopics/?org=".$ORGANISATION_ID."\\'', 5000)";
			break;
		case 1:
		default:			
			...
			<form action ="<?php echo ENTRADA_URL."/admin/settings/organisations/manage/hottopics/?section=delete&org=".$ORGANISATION_ID."&step=2";?>" method="post">
	...
	$ERROR++;
	$ERRORSTR[] = "No Hot Topics were selected to be deleted. You will now be redirected to the Hot Topics index; this will happen <strong>automatically</strong> in 5 seconds or <a href=\"".ENTRADA_URL."/admin/settings/organisations/manage/hottopics/?org=".$ORGANISATION_ID."\" style=\"font-weight: bold\">click here</a> to continue.";
