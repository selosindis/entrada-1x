...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CONFIGURATION"))) {
	...
	<div class="clearfix">
		...
		<div class="pull-right"><a href="<?php echo ENTRADA_URL; ?>/admin/settings/organisations/manage?org=<?php echo$ORGANISATION_ID;?>&amp;section=edit" class="btn">Edit <?php echo $ORGANISATION["organisation_title"];?></a></div>
