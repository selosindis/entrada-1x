...
<?php
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/organisations/manage/medbiqassessment?section=delete&amp;org=".$ORGANISATION['organisation_id'], "title" => "Deactivate Medbiquitous Assessment Method");
	...
	if ($PROCESSED["remove_ids"]) {
		switch($STEP){
			case 2:
				...
				if($NOTICE)
					echo display_notice();
				$ONLOAD[] = "setTimeout('window.location=\\'".ENTRADA_URL."/admin/settings/organisations/manage/medbiqassessment/?org=".$ORGANISATION_ID."\\'', 5000)";
				break;
			case 1:
			default:	
			...
			<form action ="<?php echo ENTRADA_URL."/admin/settings/organisations/manage/medbiqassessment/?section=delete&org=".$ORGANISATION_ID."&step=2";?>" method="post">
