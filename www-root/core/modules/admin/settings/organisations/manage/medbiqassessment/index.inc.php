...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_MEDBIQASSESSMENT"))) {
	...
	if($results){
	?>
	<form action ="<?php echo ENTRADA_URL;?>/admin/settings/organisations/manage/medbiqassessment?section=delete&amp;org=<?php echo $ORGANISATION_ID;?>" method="post">
		...
		<tbody>
			<?php
				foreach($results as $result){
					...
					echo"<td><a href=\"".ENTRADA_URL."/admin/settings/organisations/manage/medbiqassessment?section=edit&amp;org=".$ORGANISATION_ID."&amp;assessment_method_id=".$result["assessment_method_id"]."\">".$result["assessment_method"]."</a></td></tr>";
				}
			?>
		</tbody>
	</table>
