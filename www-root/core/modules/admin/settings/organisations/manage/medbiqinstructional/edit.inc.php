...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_MEDBIQINSTRUCTIONAL"))) {
	...
	switch ($STEP) {
		...
		default:	
			...
			?>
			<form action="<?php echo ENTRADA_URL."/admin/settings/organisations/manage/medbiqinstructional"."?".replace_query(array("action" => "edit", "step" => 2))."&org=".$ORGANISATION_ID; ?>" method="post">
