...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CONFIGURATION"))) {
	...
	<div class="clearfix">
		<div class="pull-right">
			<a href="<?php echo ENTRADA_URL; ?>/admin/settings/organisations/manage/metadata?section=add&amp;org=<?php echo $ORGANISATION_ID;?>" class="btn btn-primary">Add New Meta Data</a>
		</div>
	</div>
	<?php
