		...
		if ($user_record) {
			...
			switch ($STEP) {
				...
				default :
					...
					?>
					<div class="tab-pane" id="user-overview-tabs">
						<div class="tab-page" style="padding-bottom: 80px">
							<h2 class="tab">User Overview</h2>
							...
							<div style="display: block" id="opened_details">
								<table style="width: 100%; border: 1px #CCCCCC solid" cellspacing="0" cellpadding="1">
									<tr>
										<td style="height: 15px; background-image: url('https://meds.queensu.ca/evaluation/images/table-head-on.gif'); background-color: #EEEEEE; border-bottom: 1px #CCCCCC solid; padding-left: 5px">
											User Profile
										</td>
									</tr>
									<tr>
						...
						<?php $ONLOAD[] = "provStateFunction(\$F($('user-edit')['country_id']))";	?>
						<div class="tab-page">
						...
						<div class="tab-page">
							<h2 class="tab">Manage Incidents</h2>
							<h1 style="margin-top: 0px">Manage Incidents</h1>

							<ul class="page-action">
								<li><a href="<?php echo ENTRADA_URL."/admin/users?section=incident-add&id=".$PROXY_ID; ?>">Add New Incident</a></li>
							</ul>
							...
							if ($results) {
								...
								<div style="padding-top: 10px; clear: both">
									<form action="<?php echo ENTRADA_URL; ?>/admin/users?section=incident-close" method="post">
