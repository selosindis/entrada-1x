 ...
 *
 * @version $Id: incident-add.inc.php 1169 2010-05-01 14:18:49Z simpson $
*/
		...
		if ($user_record) {
			...
			switch ($STEP) {
				...
				default :
					...
					?>
					<form action="<?php echo ENTRADA_URL; ?>/admin/users?section=incident-add&amp;id=<?php echo $PROXY_ID; ?>&amp;step=2" method="post">
