 ...
 *
 * @version $Id: incident-edit.inc.php 1169 2010-05-01 14:18:49Z simpson $
*/
		...
		if ($incident_record) {
			...
			switch ($STEP) {
				...
				default :
					...
					?>
					<form action="<?php echo ENTRADA_URL; ?>/admin/users?section=incident-edit&amp;id=<?php echo $PROXY_ID; ?>&amp;incident-id=<?php echo $incident_id; ?>&amp;step=2" method="post">
