...
if((!defined("PARENT_INCLUDED")) || (!defined("IN_ANNUAL_REPORT"))) {
	...
	switch($STEP) {
		...
		default :
			...
			<form action="<?php echo ENTRADA_URL; ?>/annualreport/academic?section=add_external&amp;step=2" method="post">
			...
			<tr>
				...
				<td><input type="text" id="city_country" name="city_country" value="<?php echo html_encode($PROCESSED["city_country"]); ?>" maxlength="255" style="width: 95%" /></td>
			</tr>
			<tr>
				<td></td>
