...
if((!defined("PARENT_INCLUDED")) || (!defined("IN_ANNUAL_REPORT"))) {
	...
	if($GRADUATE_TEACHING_ID) {
		$query	= "SELECT * FROM `ar_graduate_teaching` WHERE `graduate_teaching_id`=".$db->qstr($GRADUATE_TEACHING_ID);
						...
						<tr>
							...
							<?php
								for($i=$AR_PAST_YEARS; $i<=$AR_FUTURE_YEARS; $i++)
								{
									...
									else if(isset($graduateTeachingResult["year_reported"]) && $graduateTeachingResult["year_reported"] != '')
									{
										$defaultYear = $graduateTeachingResult["year_reported"];
									}
									else 
									{
