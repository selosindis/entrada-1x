						...
						<tr>
							...
							<?php
								for($i=$AR_PAST_YEARS; $i<=$AR_FUTURE_YEARS; $i++)
								{
									...
									else if(isset($undergraduateTeachingResult["year_reported"]) && $undergraduateTeachingResult["year_reported"] != '')
									{
										$defaultYear = $undergraduateTeachingResult["year_reported"];
									}
									else 
									{
