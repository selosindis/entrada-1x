					...
					<tr>
						...
						<?php
							for($i=$AR_PAST_YEARS; $i<=$AR_FUTURE_YEARS; $i++)
							{
								...
								else if(isset($prizesResult["year_reported"]) && $prizesResult["year_reported"] != '')
								{
									$defaultYear = $prizesResult["year_reported"];
								}
								else 
								{
						...
						<td colspan="3" style="padding-top: 25px">
							...
							<tr>
								<td style="width: 25%; text-align: left">
									<input type="button" class="button" value="Cancel" onclick="window.location='<?php echo ENTRADA_URL; ?>/annualreport/prizes'" />
								</td>
