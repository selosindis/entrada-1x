					...
					<td>
						...
						<div id="pubmed_id_results" style="display: block">
							...
							<tr>
								...
								<td><input type="text" id="volume" name="volume" value="<?php echo (isset($PROCESSED["volume"]) ? utf8_decode($PROCESSED["volume"]) : utf8_decode($xml->DocSum->Item[6])); ?>" maxlength="10" style="width: 15%" /></td>
							</tr>
							<tr>
								<td></td>
								<td style="vertical-align: top"><label for="edition" class="form-required">Edition</label></td>
								<td><input type="text" id="edition" name="edition" value="<?php echo (isset($PROCESSED["edition"]) ? utf8_decode($PROCESSED["edition"]) : utf8_decode($xml->DocSum->Item[7])); ?>" maxlength="10" style="width: 15%" /></td>
							</tr>
							<tr>
								<td></td>
								<td style="vertical-align: top"><label for="pages" class="form-required">Pages</label></td>
								<td><input type="text" id="pages" name="pages" value="<?php echo (isset($PROCESSED["pages"]) ? utf8_decode($PROCESSED["pages"]) : utf8_decode($xml->DocSum->Item[8])); ?>" maxlength="10" style="width: 15%" /></td>
							</tr>
							<tr>
								<td></td>
