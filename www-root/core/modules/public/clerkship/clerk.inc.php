		...
		<div class="tab-pane" id="people-search-tabs">
			<div class="tab-page">
				...
				foreach ($results as $result) {
					...
					} elseif ($_SESSION["details"]["group"] == "student" && $result["event_type"] == "elective" && $result["event_status"] == "approval") {
            ...
            if (is_array($accessible_rotation_ids) && count($accessible_rotation_ids)) {
                ...
                <div class="tab-page">
                    ...
                    if ($results) {
                        ...
                        <input type="button" value="Download All" class="btn" onclick="window.location = '<?php echo ENTRADA_URL."/clerkship/logbook?section=csv&id=".$PROXY_ID;?>'" />
