		...
		<div class="inner-comm-body">
            ...
            switch($ACTION) {
                case "browse" :
                    ...
                    if ($TOTAL_PAGES > 1) {
                        echo "<form action=\"".ENTRADA_RELATIVE."/communities\" method=\"get\" id=\"pageSelector\">\n";
                        ...
                        if ($PAGE_PREVIOUS) {
                            echo "<a href=\"".ENTRADA_RELATIVE."/communities?".replace_query(array("pv" => $PAGE_PREVIOUS))."\"><img src=\"".ENTRADA_URL."/images/record-previous-on.gif\" border=\"0\" width=\"11\" height=\"11\" alt=\"Back to page ".$PAGE_PREVIOUS.".\" title=\"Back to page ".$PAGE_PREVIOUS.".\" style=\"vertical-align: middle\" /></a>\n";
                        } else {
