...
if (!$ENTRADA_ACL->amIAllowed("dashboard", "read")) {
	...
	$HEAD[]	= "<script type=\"text/javascript\" src=\"".ENTRADA_RELATIVE."/javascript/dashboard-event-colors.js?release=".html_encode(APPLICATION_VERSION)."\"></script>";
		...
		case "student" :
                ...
                jQuery('#dashboardCalendar').weekCalendar({
                    ...
                    eventRender : function(calEvent, $event) {
                        switch (calEvent.type) {
                            ...
                            break;
                            default :
                                dashboard_event_color(calEvent, $event);
                            break;
                        }
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="event-calendar">
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="btn-group space-above">
                            ...
                            <button class="btn wc-today space-above" onclick="jQuery('#dashboardCalendar').weekCalendar('today');"><i class="icon-refresh"></i></button>
                        </div>
                        <div class="span6">
                            <h1 class="pull-right">My Schedule</h1>
                        </div>
                    </div>
