 ...
 *
 * @version $Id: pending.inc.php 1114 2010-04-09 18:15:05Z finglanj $
 */
...
if (!defined("IN_OBSERVERSHIPS_STUDENTS")) {
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/observerships?section=pending", "title" => "Pending Observerships");
	
	
	$PAGE_META["title"]			= "Pending Observerships";
...
?>
<h1>Pending Observerships</h1>

Link to request Obs page

Table listing pending observerships (all one page)... includes icon for cancel request/confirm cancel
requested for cancel indicated in special color.
