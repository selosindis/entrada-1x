...
<p>
Welcome to the <?php echo APPLICATION_NAME; ?> Help section where you will find screencasts and tutorials about how to use the system as well as information sheets on new technologies.  If you would like to request a screencast or tutorial that is not part of the list, please use the feedback button located in sidebar once you log in.
</p>
