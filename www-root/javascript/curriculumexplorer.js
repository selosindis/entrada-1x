    ...
    if (jsonResponse.assessments != null) {
        ...
        for (var key in jsonResponse.assessments) {
            ...
            jQuery(jsonResponse.assessments[key]).each(function(i, v) {
                ...
                assessment_link.html(v.name).attr("href", SITE_URL+"/events?rid=" + v.event_id);
                assessment.append(assessment_link).append("<br /><span class=\"content-small\">Event on " + event_date.toDateString() + "</span>");
