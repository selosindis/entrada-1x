 ...
 * 
 * @version $Id: link-wizard-course.php 1171 2010-05-01 14:39:27Z ad29 $
*/
							...
							if($result) {
								...
								switch($STEP) {
									case 2 :
										...
										<div id="wizard">
											...
											<div id="footer">
												...
												<input type="button" class="button" value="Re-Edit Link" onclick="window.location='<?php echo ENTRADA_URL; ?>/link-wizard-course.php?action=edit&amp;id=<?php echo $IDENTIFIER; ?>&amp;lid=<?php echo $LINK_ID; ?>'" style="float: right; margin: 4px 10px 4px 0px" />
											</div>
										</div>
										<?php
									break;
									...
									default :
										...
										?>
										<div id="wizard">
											<form id="wizard-form" action="<?php echo ENTRADA_URL; ?>/link-wizard-course.php?action=edit&amp;id=<?php echo $IDENTIFIER; ?>&amp;lid=<?php echo $LINK_ID; ?>&amp;step=2" method="post" style="display: inline">
											<div id="header">
												<span class="content-heading" style="color: #FFFFFF">Link Wizard</span> <span style="font-size: 11px; color: #FFFFFF"><strong>Editing</strong> <?php echo html_encode($PROCESSED["link_title"]); ?></span>
											</div>
											<div id="body">
					...
					default :
							...
							case 2 :
								...
								if(!$ERROR) {
									...
									if(!$ERROR) {
										...
										$result	= $db->GetRow($query);
										if($result) {
											$ONLOAD[]		= "alert('A link to ".addslashes($PROCESSED["link"])." already exists in this course.')";
						...
						switch($STEP) {
							case 2 :
								...
								<div id="wizard">
									<div id="header">
										<span class="content-heading" style="color: #FFFFFF">Link Wizard</span> <span style="font-size: 11px; color: #FFFFFF"><strong>Adding</strong> new course link</span>
									</div>
									<div id="body">
									...
									<div id="footer">
										<input type="button" class="button" value="Close" onclick="closeWizard()" style="float: left; margin: 4px 0px 4px 10px" />
										<input type="button" class="button" value="Add Another Link" onclick="window.location='<?php echo ENTRADA_URL; ?>/link-wizard-course.php?id=<?php echo $IDENTIFIER; ?>&amp;action=add'" style="float: right; margin: 4px 10px 4px 0px" />
									</div>
								</div>
								<?php
							break;
							...
							default :
								...
								?>
								<div id="wizard">
									<form id="wizard-form" action="<?php echo ENTRADA_URL; ?>/link-wizard-course.php?action=add&amp;id=<?php echo $IDENTIFIER; ?>&amp;step=2" method="post" style="display: inline">
									<div id="header">
										<span class="content-heading" style="color: #FFFFFF">Link Wizard</span> <span style="font-size: 11px; color: #FFFFFF"><strong>Adding</strong> new course link</span>
									</div>
									<div id="body">
