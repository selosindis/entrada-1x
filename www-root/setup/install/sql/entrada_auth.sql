...
('objective', NULL, 'group', 'staff', 1, NULL, NULL, 1, 1, NULL),
('objective', NULL, 'group', 'faculty', 1, NULL, NULL, 1, 1, NULL),
('objectivecontent', NULL, 'group', 'staff', 1, NULL, NULL, 1, 1, NULL),
('objectivecontent', NULL, 'group', 'faculty', 1, NULL, NULL, 1, 1, NULL),
('objective', NULL, 'group:role', 'staff:admin', 1, 1, 1, 1, 1, NULL),
('objective', NULL, 'group:role', 'medtech:admin', 1, 1, 1, 1, 1, NULL),
